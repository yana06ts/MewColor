...
export const PUZZLE_TEMPLATES: PuzzleTemplate[] = [
  {
    ...
    colors: [
      ...
      { number: 2, hex: "#FFF9E6", name: "Warm Ivory Cream" },
  ...
  },
  {
    ...
    colors: [
      ...
      { number: 2, hex: "#424242", name: "Midnight Grey" },
      { number: 5, hex: "#FFC107", name: "Curious Gold Eyes" },
      { number: 6, hex: "#FF8A80", name: "Dusky Rosette Cheek" },
      { number: 7, hex: "#FFFFFF", name: "White Socks" }
    ],
    difficulty: "Medium",
    yarnReward: 85,
    description: "A sleepy kuro cat styled into a circular puffy loaf with adorable white socks."
  },
  {
    id: "bubble_tea",
    name: "Neko Boba Cup 🧋",
